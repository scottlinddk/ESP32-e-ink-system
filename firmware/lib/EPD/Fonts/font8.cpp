// Font8 — 5 × 8 pixels, row-major, 1 byte per row, MSB = leftmost column.
// bytes_per_char = 8.  Covers ASCII 0x20 (space) … 0x7E (~).
//
// Fix for error 1: The original Elecrow library had:
//   #include <avr/pgmspace.h>
// That header only exists on AVR toolchains.  On ESP32/Arduino the pgmspace
// compatibility layer is provided automatically via Arduino.h, so no explicit
// include is needed.  PROGMEM, pgm_read_byte, etc. are no-ops on ESP32 because
// the address space is flat (no Harvard memory separation).
...
static const uint8_t Font8_Table[] = {
    ...
    // 0x2A '*'
    0x00,0x20,0xF8,0x20,0x50,0x00,0x00,0x00,
    // 0x2B '+'
    ...
    // 0x40 '@'
    0x70,0x88,0xA8,0xB8,0xA0,0x88,0x70,0x00,
    // 0x41 'A'
    ...
    // 0x67 'g'
    0x00,0x78,0x88,0x88,0x78,0x08,0x88,0x70,
    // 0x68 'h'
